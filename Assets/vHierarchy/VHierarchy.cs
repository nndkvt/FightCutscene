...
namespace VHierarchy
{
    public static class VHierarchy
    {
        static void GameObjectRowGUI(GameObject go, Rect rowRect)
        {
            ...
            var isRowHovered = fullRowRect.AddWidthFromRight(123).IsHovered();
            ...
            void setState()
            {
                ...
                isRowBeingRenamed = isHierarchyFocused && isRowSelected && EditorGUIUtility.editingTextField;
            ...
            void drawing()
            {
                ...
                void calcDefaultBackground()
                {
                    ...
                    if (isRowSelected && !isRowBeingRenamed)
                        defaultBackground = isHierarchyFocused ? selectedFocused : selectedUnfocused;
